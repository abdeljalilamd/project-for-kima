    ...
    <header>
        <nav class="switch">
            ...
            <div class="links">
                ...
                <div class="link"><a href="#">Career Advice</a></div>
                <div class="link">
            ...
            <div class="join  user">
                @auth
                    ...
                    <div class="dropdown user">
                        <a class="join-us"  data-bs-toggle="dropdown" aria-expanded="false">
                            {{-- <img src="{{ route('file.picture', ['filename' =>Auth::user()->picture])}}" class="user-picture"  alt="Picture"> --}}
                        </a>
                        <ul class="dropdown-menu">
                            <li><h6 class="dropdown-header">OnWay</h6></li>
                            <li><a class="dropdown-item" href="{{route('onway.logout')}}">Log out</a></li>
                            <li><a href="#" >
                ...
                @else
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><h6 class="dropdown-header">Employer</h6></li>
                            <li><a class="dropdown-item" href="#">Create Employer Account</a></li>
                            <li><h6 class="dropdown-header">Job Seeker</h6></li>
                            <li><a class="dropdown-item" href="{{route('onway.register')}}">Create Job Seeker Account</a></li>
                            <li><h6 class="dropdown-header">OnWay</h6></li>
                            <li><a class="dropdown-item" href="{{route('onway.login')}}">Log in</a></li>
                            <li><a href="#">
                                <button class="btn btn-success m-2" id="modeToggle"></button>
                                </a>
                            </li>
